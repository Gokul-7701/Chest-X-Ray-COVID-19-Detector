...
model.add(Dense(8192, activation='relu', kernel_regularizer=regularizers.l1_l2(l1=1e-15, l2=1e-15), bias_regularizer=regularizers.l1_l2(l1=1e-15, l2=1e-15)))
model.add(BatchNormalization(momentum=0.1, epsilon=0.1))
model.add(Dropout(0.6))
model.add(Dense(4096, activation='relu', kernel_regularizer=regularizers.l1_l2(l1=1e-15, l2=1e-15), bias_regularizer=regularizers.l1_l2(l1=1e-15, l2=1e-15)))
model.add(BatchNormalization(momentum=0.1, epsilon=0.1))
model.add(Dropout(0.6))
model.add(Dense(2, activation='softmax'))
model.compile(optimizer="rmsprop",loss='categorical_crossentropy', metrics=['accuracy'])
model.load_weights("Gokul")
